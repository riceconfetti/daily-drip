...
>
	...
	>
		<h2 class="text-white text-[.35rem] sm:text-[.5rem] md:text-xs lg:text-2xs xl:text-xs">
			{character.bannerName}
		</h2>
		<h1 class="text-white text-[.6rem] sm:text-sm md:text-xl lg:text-base xl:text-lg">
			{character.name}
		</h1>
	</div>
