...
<div
	class="relative flex h-auto w-full items-center justify-between gap-2 rounded-sm bg-gradient-to-r from-[#272317] to-[#8D7D52] text-white"
>
	<div class="h-min p-2 pr-4 sm:max-w-[130px] lg:max-w-[210px]">
		<h1
