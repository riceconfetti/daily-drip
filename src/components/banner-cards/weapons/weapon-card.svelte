<script lang="ts">
	...
	export let weapons, images, game
</script>
...
<section class="flex w-full flex-col flex-grow">
	...
	<div
		class={`grid grid-cols-[1fr_1fr_40%] gap-2 flex-grow ${game == 'wuwa' ? 'grid-cols-[1fr_65%]' : game == 'zzz' ? 'grid-cols-[auto_50%]' : 'grid-cols-[1fr_1fr_45%] lg:grid-cols-[1fr_1fr_40%]'}`}
	>
