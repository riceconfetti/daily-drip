...
//         character.images = {
//           gachaSplash: `./images/characters/wuwa/${character.name.toLowerCase()}/gachaSpash.png`,
//           gachaCard: `./images/characters/wuwa/${character.name.toLowerCase()}/gachaCard.png`,
//           bannerCard: `./images/characters/wuwa/${character.name.toLowerCase()}/bannerCard.png`,
//         };
//       }
